...
void main() {
  runApp(OutgoingVoiceCall(null, null, null));
}

class OutgoingVoiceCall extends StatefulWidget {
  final context, string, opponent;
  OutgoingVoiceCall(this.context, this.string, this.opponent);

  @override
  OutgoingVoiceCallState createState() => OutgoingVoiceCallState();
}

class OutgoingVoiceCallState extends State<OutgoingVoiceCall> with WidgetsBindingObserver {
  var channel = null;
  ...
  void initData() async {
    setState(() {
      Global.CURRENT_SCREEN = "outgoing_voice_call";
    });
                          ...
                          children: [
                            ...
                            (() {
                              if (totalSecondsShown) {
                                ...
                                return Text(widget.string.text98, style: TextStyle(color: Colors.white, fontSize: 18));
                              }
                            }())
                          ]
                      )
