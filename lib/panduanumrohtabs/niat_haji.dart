...
void main() {
  runApp(NiatHaji(null, null));
}

class NiatHaji extends StatefulWidget {
  final context, string;
  NiatHaji(this.context, this.string);

  @override
  NiatHajiState createState() => NiatHajiState();
}

class NiatHajiState extends State<NiatHaji> with WidgetsBindingObserver {
          ...
          Container(
              ...
              child: Row(
                  ...
                  children: [
                    ...
                    Text(widget.string.text229, style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.bold)),
