...
void main() {
  runApp(PanduanHaji(null, null));
}

class PanduanHaji extends StatefulWidget {
  final context, string;
  PanduanHaji(this.context, this.string);

  @override
  PanduanHajiState createState() => PanduanHajiState();
}

class PanduanHajiState extends State<PanduanHaji> with WidgetsBindingObserver {
  var duas = [];
  var videoPath = "";
                      ...
                      children: [
                        SingleChildScrollView(
                            child: Column(
                                ...
                                children: [
                                  SizedBox(height: 10),
                                  Text(widget.string.text221, style: TextStyle(color: Colors.black, fontSize: 14, fontWeight: FontWeight.bold)),
                                  SizedBox(height: 5),
                                  (() {
