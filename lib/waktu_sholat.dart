...
void main() {
  runApp(WaktuSholat(null, null, null));
}

class WaktuSholat extends StatefulWidget {
  final context, string, sholat;
  WaktuSholat(this.context, this.string, this.sholat);

  @override
  WaktuSholatState createState() => WaktuSholatState();
}

class WaktuSholatState extends State<WaktuSholat> with WidgetsBindingObserver {
          ...
          Expanded(
              child: SingleChildScrollView(
                  child: Padding(
                      ...
                      child: Text(widget.sholat['waktu']['description'].toString(), style: TextStyle(
